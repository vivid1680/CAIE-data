...
def ingest_metadata():
    ...
    papers = [
        ['9709', '2024', 'March', '1', '2', '11', '75', '110'],
        ['9709', '2024', 'March', '3', '2', '11', '75', '110'],
        ['9709', '2024', 'March', '5', '2', '7', '50', '75'],
    ]
    for p in papers:
    ...
    boundaries = [
        ['9709', '2024', 'March', '1', '2', 'A', '63'],
        ['9709', '2024', 'March', '1', '2', 'B', '57'],
        ['9709', '2024', 'March', '1', '2', 'C', '47'],
        ['9709', '2024', 'March', '1', '2', 'D', '38'],
        ['9709', '2024', 'March', '1', '2', 'E', '29'],
        
        ['9709', '2024', 'March', '3', '2', 'A', '58'],
        ['9709', '2024', 'March', '3', '2', 'B', '52'],
        ['9709', '2024', 'March', '3', '2', 'C', '44'],
        ['9709', '2024', 'March', '3', '2', 'D', '35'],
        ['9709', '2024', 'March', '3', '2', 'E', '27'],
        
        ['9709', '2024', 'March', '5', '2', 'A', '44'],
        ['9709', '2024', 'March', '5', '2', 'B', '39'],
        ['9709', '2024', 'March', '5', '2', 'C', '33'],
        ['9709', '2024', 'March', '5', '2', 'D', '26'],
        ['9709', '2024', 'March', '5', '2', 'E', '20'],
    ]
    for b in boundaries:
    ...
    for page in pages:
        ...
        for line in lines:
            ...
            if current_q and p_match:
                ...
                image_path = f"images/{subject}_m24_{paper}{variant}_q{current_q}.png"
...
if __name__ == "__main__":
    ingest_metadata()
    parse_qp('9709_m24_qp12.txt', '9709', '2024', 'March', '1', '2')
    parse_qp('9709_m24_qp32.txt', '9709', '2024', 'March', '3', '2')
    parse_qp('9709_m24_qp52.txt', '9709', '2024', 'March', '5', '2')
    parse_ms('9709_m24_ms12.txt', '9709', '2024', 'March', '1', '2')
    parse_ms('9709_m24_ms32.txt', '9709', '2024', 'March', '3', '2')
    parse_ms('9709_m24_ms52.txt', '9709', '2024', 'March', '5', '2')
